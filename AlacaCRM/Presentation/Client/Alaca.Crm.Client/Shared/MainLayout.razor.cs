...
namespace Alaca.Crm.Client.Shared
{
    ...
    {
        [Inject] CustomAuthStateProvider _authenticationStateTask { get; set; }
        ...
        private async Task LoadDataAsync()
        {
            ...
            if (user.Identity?.IsAuthenticated == true)
            {
                ...
                var currentUserResult = await _userService.GetById(Guid.Parse(CurrentUserId));
                if (currentUserResult == null || !currentUserResult.Success || currentUserResult.Data == null)
                {
    ...
    /*public partial class MainLayout
    {
        ...
        {
            _interceptor.RegisterEvent();
            ProjectCompanyName = await _localStorageService.GetItem<string>("ProjectCompanyName");
        }
