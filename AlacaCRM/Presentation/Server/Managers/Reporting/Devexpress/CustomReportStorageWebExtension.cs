...
using System.IO;
using System.Linq;
using Alaca.Crm.Server.Reports;
using DevExpress.XtraReports.UI;

namespace Alaca.Crm.Server.Managers.Reporting.Devexpress
{
    public class CustomReportStorageWebExtension : DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension
    {
        ...
        {
            report.SaveLayoutToXml(report.Name);
            //report.SaveDocument("/Reports/"+report.Name+".vsrepx");
